...
$donorIDNumber = mysqli_real_escape_string($conn,$_POST['donorIdNumber']);
$sql="SELECT * FROM donor_information WHERE id_number='$donorIDNumber'";
                    ...
                    <tr>
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <td>
<!--                                    <input type="radio" name="anyComplications" value="Yes" required>&nbsp;Yes-->
<!--                                    <input type="radio" name="anyComplications" value="No" required>&nbsp;No-->
